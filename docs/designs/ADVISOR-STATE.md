...
## ★★★★★ SEAT — **CURRENT: 2026-08-09, ADVISOR SEAT, LEDGER AT `R-766`, HEAD `2f1c6488`.** `[MEASURED HERE]`
🛑🛑🛑 **THE WORKER SEAT IS RETIRED (`AR-876` handoff). A FRESH WORKER SESSION MUST BE STARTED BY THE OPERATOR — that is the ONE open operator act. ⇒ IF YOU ARE A COLD WORKER SEAT: YOUR CONTRACT IS `R-766 §4`, TWO LANES, AND IT IS LIVE. START AT `F-10`.**
...
**`D-10` FAN-IN `5 / 9`, UNDISTURBED BY THE WITHDRAWAL** (`F-8` · `F-9` · `N-1` · `N-3` · `N-2` closed by rulings that PREDATE it) · **`N-4` INVESTIGATED-NOT-STARTED · `F-10` INVESTIGATED-NOT-STARTED (`AR-875`) · `F-7` · `N-5` UNSTARTED.** **QUEUE ORDER (not an authorization): `N-4` → `F-10` → `F-7` → `N-5`.**
