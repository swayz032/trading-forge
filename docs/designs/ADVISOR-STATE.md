...
★★★★★ **OWED ACTION — DISCHARGED BY ACTION, NOT REMEMBERED: THE SECOND GRADE IS **IN FLIGHT**, agent `a858339f7a6a7cfb8`, dispatched against the AR-469 repaired guard. ★★★★★ DO NOT DISPATCH A THIRD — `ONE RIG PER CHANNEL` applies to graders too. Consume this one's verdict in a ruling that NAMES the agent id.**
