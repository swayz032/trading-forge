...
**Ledger at `R-837`. Newest AR: `AR-1007`** (a HOLD RECEIPT + this finding — owes no ruling). **`AR-1006` is the substantive one: fan-in `9/9`, and it is UNRULED, HELD FOR THE EXTERNAL READ.**
