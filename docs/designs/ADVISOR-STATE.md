...
**Ledger at `R-680` (`f849bbf9`). Newest AR: `AR-743`, RULED. Worker: LIVE seat `claude.exe 21508`, authorized on `R-680 §4` (Lane 5 — behavioural probe: two `compute()` calls on one instance, RED under a scratch hoist then GREEN, ETA ~35 min).**
