...
> Generated at commit `ed6f5d93a039c3f20b413ac0b3734c6172ea8b55`
...
Total entry points: **211**.  Modules reachable from them: **767** of **2222** parsed files.

<details><summary>All 211 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=211 |
| C6 | a registered route module is reachable | PASS | modules reachable=767 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=211 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 226 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 226 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 226 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 226 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 226 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 226 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 226 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 226 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 226 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 226 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 226 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 226 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 226 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 226 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 226 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 226 | AMBIG |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 226 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 226 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 226 | AMBIG |
...
| `compile_svkm_v2_1_vertical` | function | `src/engine/extraction/svkm_v2_1_compile.py:395` | 0 | unique |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 226 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 226 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 226 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 226 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 226 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 226 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 226 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 226 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 226 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 226 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 226 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 226 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 226 | AMBIG |
