...
> Generated at commit `6098124129c015ff81c6fa5c5ac7078c6915e596`  (worktree DIRTY at generation time)
...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 312 | 410 | 128809 | 2007 |
...
| `src/` test files | 1135 | tests are the reference surface, never the symbol surface |
...
Total entry points: **205**.  Modules reachable from them: **759** of **2203** parsed files.

<details><summary>All 205 entry points and why each was counted</summary>
...
| C2 | WIRED is reachable by the classifier | PASS | WIRED=3762 |
| C3 | BUILT-UNREACHABLE is reachable by the classifier | PASS | BUILT-UNREACHABLE=1172 |
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 75.4% of 4990 rows |
| C5 | server entry point discovered | PASS | entry points discovered=205 |
| C6 | a registered route module is reachable | PASS | modules reachable=759 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=205 |
...
| `src/engine/extraction` | 311 | 0 | 50 | 0 | 0 | 361 |
...
Of **1172** `BUILT-UNREACHABLE` symbols, **632 have test coverage but no production caller**.
...
_...332 more omitted from this table._
...
<details><summary><code>src/engine/extraction</code> - 50 symbols</summary>
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 221 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 221 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 221 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 221 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 221 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 221 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 221 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 221 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 221 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 221 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 221 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 221 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 221 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 221 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 221 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 221 | AMBIG |
...
<details><summary><code>src/engine/extraction</code> - 311 symbols</summary>
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 221 | AMBIG |
...
| `evaluate_evidence_relevance` | function | `src/engine/extraction/evidence_relevance.py:128` | 5 | unique |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 221 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 221 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 221 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 221 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 221 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 221 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 221 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 221 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 221 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 221 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 221 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 221 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 221 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 221 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 221 | AMBIG |
