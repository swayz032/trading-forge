...
> Generated at commit `05412188cea17cb5af8200660bddb248c25d0aae`
...
Total entry points: **237**.  Modules reachable from them: **793** of **2254** parsed files.

<details><summary>All 237 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=237 |
| C6 | a registered route module is reachable | PASS | modules reachable=793 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=237 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 253 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 253 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 253 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 253 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 253 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 253 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 253 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 253 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 253 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 253 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 253 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 253 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 253 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 253 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 253 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 253 | AMBIG |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 253 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 253 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 253 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 253 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 253 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 253 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 253 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 253 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 253 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 253 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 253 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 253 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 253 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 253 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 253 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 253 | AMBIG |
