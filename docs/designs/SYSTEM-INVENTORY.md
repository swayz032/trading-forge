...
> Generated at commit `dd4579d14b4360aac17bb839b856426e6b560bef`
...
Total entry points: **225**.  Modules reachable from them: **781** of **2242** parsed files.

<details><summary>All 225 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=225 |
| C6 | a registered route module is reachable | PASS | modules reachable=781 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=225 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 241 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 241 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 241 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 241 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 241 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 241 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 241 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 241 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 241 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 241 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 241 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 241 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 241 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 241 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 241 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 241 | AMBIG |
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 73 | unique |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 241 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 241 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 241 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 241 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 241 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 241 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 241 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 241 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 241 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 241 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 241 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 241 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 241 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 241 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 241 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 241 | AMBIG |
