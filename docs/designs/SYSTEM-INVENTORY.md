...
> Generated at commit `c8136ed5edeb287e0a24711f85d6859787d0d9be`  (worktree DIRTY at generation time)
...
Total entry points: **219**.  Modules reachable from them: **775** of **2234** parsed files.
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 235 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 235 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 235 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 235 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 235 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 235 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 235 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 235 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 235 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 235 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 235 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 235 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 235 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 235 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 235 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 235 | AMBIG |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 235 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 235 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 235 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 235 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 235 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 235 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 235 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 235 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 235 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 235 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 235 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 235 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 235 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 235 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 235 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 235 | AMBIG |
