...
> Generated at commit `23f44d38c2818331aeb03f4e10aa26aa2ccdec3f`
...
Total entry points: **231**.  Modules reachable from them: **787** of **2248** parsed files.

<details><summary>All 231 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=231 |
| C6 | a registered route module is reachable | PASS | modules reachable=787 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=231 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 247 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 247 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 247 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 247 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 247 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 247 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 247 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 247 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 247 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 247 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 247 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 247 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 247 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 247 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 247 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 247 | AMBIG |
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 79 | unique |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 247 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 247 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 247 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 247 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 247 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 247 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 247 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 247 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 247 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 247 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 247 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 247 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 247 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 247 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 247 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 247 | AMBIG |
...
| `strategies` | const | `src/server/db/schema.ts:58` | 156 | AMBIG |
