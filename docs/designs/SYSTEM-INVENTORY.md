...
> Generated at commit `e26a4004e9b5dab1d1e986326e3030a427cd272b`  (worktree DIRTY at generation time)
...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 311 | 407 | 128476 | 1997 |
...
| `src/` test files | 1132 | tests are the reference surface, never the symbol surface |
...
Total entry points: **198**.  Modules reachable from them: **751** of **2187** parsed files.

<details><summary>All 198 entry points and why each was counted</summary>
...
| C2 | WIRED is reachable by the classifier | PASS | WIRED=3752 |
| C3 | BUILT-UNREACHABLE is reachable by the classifier | PASS | BUILT-UNREACHABLE=1172 |
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 75.3% of 4980 rows |
| C5 | server entry point discovered | PASS | entry points discovered=198 |
| C6 | a registered route module is reachable | PASS | modules reachable=751 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=198 |
...
| `src/engine/extraction` | 301 | 0 | 50 | 0 | 0 | 351 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 214 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 214 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 214 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 214 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 214 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 214 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 214 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 214 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 214 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 214 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 214 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 214 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 214 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 214 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 214 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 214 | AMBIG |
...
<details><summary><code>src/engine/extraction</code> - 301 symbols</summary>
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 214 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 214 | AMBIG |
...
| `DurableAttemptLedger` | class | `src/engine/extraction/isolated_attempt_receipt.py:71` | 6 | unique |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 214 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 214 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 214 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 214 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 214 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 214 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 214 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 214 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 214 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 214 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 214 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 214 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 214 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 214 | AMBIG |
