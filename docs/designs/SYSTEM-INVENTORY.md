...
> Generated at commit `662b9e8addfe3ea6fa5259909e277a9f677b926b`  (worktree DIRTY at generation time)
...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 298 | 389 | 124790 | 1924 |
...
| `src/` test files | 1114 | tests are the reference surface, never the symbol surface |
...
Total entry points: **180**.  Modules reachable from them: **721** of **2138** parsed files.
...
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 75.2% of 4907 rows |
...
| C12 | symbols enumerated in both languages | PASS | py=1924 ts=2933 |
...
* **Name collision biases toward `WIRED` - and the affected population is MEASURED, not
  ...
  **219 of 4588 enumerated symbol names (4.8%) are defined in more than one file, covering
  488 of 4857 symbol rows (10.0%).**  Every symbol table below marks those rows `AMBIG`.
...
| `src/engine/extraction` | 241 | 0 | 39 | 0 | 0 | 280 |
...
Of **1161** `BUILT-UNREACHABLE` symbols, **616 have test coverage but no production caller**.
...
| `FidelityFinding` | class | `src/engine/extraction/source_fidelity_guard.py:38` | 1 | unique |
| `check_condition_fidelity` | function | `src/engine/extraction/source_fidelity_guard.py:142` | 1 | unique |
...
| `FidelityFinding` | class | `src/engine/extraction/source_fidelity_guard.py:38` | defining module is not reachable from any measured entry point |
| `_norm` | function | `src/engine/extraction/source_fidelity_guard.py:102` | defining module is not reachable from any measured entry point |
| `_has_certainty` | function | `src/engine/extraction/source_fidelity_guard.py:106` | defining module is not reachable from any measured entry point |
| `_has_hedge` | function | `src/engine/extraction/source_fidelity_guard.py:114` | defining module is not reachable from any measured entry point |
| `_numeric_tokens` | function | `src/engine/extraction/source_fidelity_guard.py:122` | defining module is not reachable from any measured entry point |
| `check_condition_fidelity` | function | `src/engine/extraction/source_fidelity_guard.py:142` | no non-test reference outside its own definition; 1 test file(s) do reference it |
