...
> Generated at commit `88209ba28a16ff88d2bc95e6732f62893b668085`
...
Total entry points: **221**.  Modules reachable from them: **777** of **2238** parsed files.

<details><summary>All 221 entry points and why each was counted</summary>
...
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 75.6% of 5020 rows |
| C5 | server entry point discovered | PASS | entry points discovered=221 |
| C6 | a registered route module is reachable | PASS | modules reachable=777 |
| C7 | env-flag extractor fires in both languages | PASS | py files with env reads=131, ts=346 |
...
| C13 | DECLARED-ABSENT probe is live | PASS | DECLARED-ABSENT=45 (probe runs; 0 would be a legitimate reading) |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=221 |
...
**45 rows.**  Two probes feed this: unresolvable internal import specifiers, and
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 237 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 237 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 237 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 237 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 237 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 237 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 237 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 237 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 237 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 237 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 237 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 237 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 237 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 237 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 237 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 237 | AMBIG |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 237 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 237 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 237 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 237 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 237 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 237 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 237 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 237 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 237 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 237 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 237 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 237 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 237 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 237 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 237 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 237 | AMBIG |
