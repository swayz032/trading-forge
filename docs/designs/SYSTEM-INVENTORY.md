...
> Generated at commit `fd4421a8277b38d0d79a68e28061615102169ead`  (worktree DIRTY at generation time)
...
Total entry points: **94**.  Modules reachable from them: **618** of **2073** parsed files.
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 184 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 184 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 184 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 184 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:8219` | 184 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 184 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 184 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 184 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 184 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 184 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 184 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 184 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 184 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 184 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 184 | AMBIG |
