...
> Generated at commit `0c49dca24870b8f334343dd4134405edab021d01`
...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 311 | 406 | 128476 | 1997 |
...
| `src/` test files | 1131 | tests are the reference surface, never the symbol surface |
...
Total entry points: **197**.  Modules reachable from them: **750** of **2185** parsed files.

<details><summary>All 197 entry points and why each was counted</summary>
...
| C2 | WIRED is reachable by the classifier | PASS | WIRED=3751 |
| C3 | BUILT-UNREACHABLE is reachable by the classifier | PASS | BUILT-UNREACHABLE=1173 |
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 75.3% of 4980 rows |
| C5 | server entry point discovered | PASS | entry points discovered=197 |
| C6 | a registered route module is reachable | PASS | modules reachable=750 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=197 |
...
| `src/engine/extraction` | 300 | 0 | 51 | 0 | 0 | 351 |
...
Of **1173** `BUILT-UNREACHABLE` symbols, **633 have test coverage but no production caller**.
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 19 | unique |
...
_...333 more omitted from this table._
...
<details><summary><code>src/engine/extraction</code> - 51 symbols</summary>
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 213 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 213 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 213 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 213 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 213 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 213 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 213 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 213 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 213 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 213 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 213 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 213 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 213 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 213 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 213 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 213 | AMBIG |
...
<details><summary><code>src/engine/extraction</code> - 300 symbols</summary>
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 213 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 213 | AMBIG |
...
| `DurableAttemptLedger` | class | `src/engine/extraction/isolated_attempt_receipt.py:71` | 5 | unique |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 213 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 213 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 213 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 213 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 213 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 213 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 213 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 213 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 213 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 213 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 213 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 213 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 213 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 213 | AMBIG |
