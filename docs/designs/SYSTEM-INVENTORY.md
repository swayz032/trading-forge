...
> Generated at commit `00344c2c5f949584f8d7c794a82c4dcfbb846158`  (worktree DIRTY at generation time)
...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 291 | 358 | 120556 | 1870 |
...
| `src/` test files | 1075 | tests are the reference surface, never the symbol surface |
...
Total entry points: **94**.  Modules reachable from them: **618** of **2072** parsed files.
...
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 67.2% of 4830 rows |
...
Of **1536** `BUILT-UNREACHABLE` symbols, **775 have test coverage but no production caller**.
...
| `produce_spec_artifact_from_record` | function | `src/engine/extraction/spec_producer.py:959` | 4 | unique |
...
| `rehydrate_candidate` | function | `src/engine/opening_range_candidate_receipt.py:253` | 1 | unique |
...
| `produce_spec_artifact_from_record` | function | `src/engine/extraction/spec_producer.py:959` | no non-test reference outside its own definition; 4 test file(s) do reference it |
...
| `build_execution_candidate_receipts` | function | `src/engine/opening_range_candidate_receipt.py:163` | no non-test reference outside its own definition; 1 test file(s) do reference it |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 183 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 183 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 183 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 183 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:8219` | 183 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 183 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 183 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 183 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 183 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 183 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 183 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 183 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 183 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 183 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 183 | AMBIG |
