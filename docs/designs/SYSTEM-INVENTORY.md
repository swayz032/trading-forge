...
> Generated at commit `18e6fa04faee450e43a7a1ea91147aef64aa375a`  (worktree DIRTY at generation time)
...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 312 | 409 | 128809 | 2007 |
...
|---|---:|---|
| Python class methods | 458 | one row per method would swamp the map; a method is reached through its class |
| Python nested / inner functions | 87 | not part of any module's import surface |
| Non-exported TypeScript declarations | UNENUMERATED | module-private by construction |
| `src/` test files | 1134 | tests are the reference surface, never the symbol surface |
...
Total entry points: **202**.  Modules reachable from them: **755** of **2198** parsed files.

<details><summary>All 202 entry points and why each was counted</summary>
...
| C3 | BUILT-UNREACHABLE is reachable by the classifier | PASS | BUILT-UNREACHABLE=1181 |
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 75.2% of 4990 rows |
...
| C12 | symbols enumerated in both languages | PASS | py=2007 ts=2933 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=202 |
...
* **Name collision biases toward `WIRED` - and the affected population is MEASURED, not
  ...
  **221 of 4669 enumerated symbol names (4.7%) are defined in more than one file, covering
  492 of 4940 symbol rows (10.0%).**  Every symbol table below marks those rows `AMBIG`.
...
| `src/engine/extraction` | 302 | 0 | 59 | 0 | 0 | 361 |
...
Of **1181** `BUILT-UNREACHABLE` symbols, **637 have test coverage but no production caller**.
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 20 | unique |
...
| `build_batch_task` | function | `src/engine/extraction/batch_locator.py:148` | 1 | unique |
| `compare_to_reference` | function | `src/engine/extraction/batch_locator.py:335` | 1 | unique |
| `parse_batch_return` | function | `src/engine/extraction/batch_locator.py:220` | 1 | unique |
| `production_rules_block` | function | `src/engine/extraction/batch_locator.py:85` | 1 | unique |
...
| `verify_answer` | function | `src/engine/extraction/batch_locator.py:258` | 1 | unique |
...
| `capture_subagent_stop_final` | function | `src/engine/extraction/g2d_subagentstop_capture.py:298` | 1 | unique |
| `extract_subagent_stop_fields` | function | `src/engine/extraction/g2d_subagentstop_capture.py:169` | 1 | unique |
...
<details><summary><code>src/engine/extraction</code> - 59 symbols</summary>

| Symbol | Kind | Defined at | Reason |
|---|---|---|---|
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | defining module is not reachable from any measured entry point |
| `production_rules_block` | function | `src/engine/extraction/batch_locator.py:85` | defining module is not reachable from any measured entry point |
| `build_batch_brief` | function | `src/engine/extraction/batch_locator.py:103` | defining module is not reachable from any measured entry point |
| `build_batch_task` | function | `src/engine/extraction/batch_locator.py:148` | defining module is not reachable from any measured entry point |
| `screen_task_for_leakage` | function | `src/engine/extraction/batch_locator.py:174` | defining module is not reachable from any measured entry point |
| `screen_is_live` | function | `src/engine/extraction/batch_locator.py:199` | defining module is not reachable from any measured entry point |
| `parse_batch_return` | function | `src/engine/extraction/batch_locator.py:220` | defining module is not reachable from any measured entry point |
| `verify_answer` | function | `src/engine/extraction/batch_locator.py:258` | defining module is not reachable from any measured entry point |
| `verify_trial` | function | `src/engine/extraction/batch_locator.py:270` | defining module is not reachable from any measured entry point |
| `stability` | function | `src/engine/extraction/batch_locator.py:286` | defining module is not reachable from any measured entry point |
| `_overlap_fraction` | function | `src/engine/extraction/batch_locator.py:328` | defining module is not reachable from any measured entry point |
| `compare_to_reference` | function | `src/engine/extraction/batch_locator.py:335` | defining module is not reachable from any measured entry point |
...
| `SubagentStopNotTerminal` | class | `src/engine/extraction/g2d_subagentstop_capture.py:102` | defining module is not reachable from any measured entry point |
| `_launch_ack_path` | function | `src/engine/extraction/g2d_subagentstop_capture.py:110` | defining module is not reachable from any measured entry point |
| `record_async_launch_ack` | function | `src/engine/extraction/g2d_subagentstop_capture.py:114` | no non-test reference outside its own definition; 1 test file(s) do reference it |
| `_read_launch_ack` | function | `src/engine/extraction/g2d_subagentstop_capture.py:161` | defining module is not reachable from any measured entry point |
| `extract_subagent_stop_fields` | function | `src/engine/extraction/g2d_subagentstop_capture.py:169` | defining module is not reachable from any measured entry point |
| `_subagent_stop_event_path` | function | `src/engine/extraction/g2d_subagentstop_capture.py:222` | defining module is not reachable from any measured entry point |
| `_validate_launch_ack_identity` | function | `src/engine/extraction/g2d_subagentstop_capture.py:226` | defining module is not reachable from any measured entry point |
| `capture_subagent_stop_event` | function | `src/engine/extraction/g2d_subagentstop_capture.py:248` | no non-test reference outside its own definition; 1 test file(s) do reference it |
| `capture_subagent_stop_final` | function | `src/engine/extraction/g2d_subagentstop_capture.py:298` | defining module is not reachable from any measured entry point |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 218 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 218 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 218 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 218 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 218 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 218 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 218 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 218 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 218 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 218 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 218 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 218 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 218 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 218 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 218 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 218 | AMBIG |
...
<details><summary><code>src/engine/extraction</code> - 302 symbols</summary>
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 218 | AMBIG |
...
| `evaluate_evidence_relevance` | function | `src/engine/extraction/evidence_relevance.py:128` | 3 | unique |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 218 | AMBIG |
| `AttemptRefused` | class | `src/engine/extraction/isolated_attempt_receipt.py:50` | 4 | unique |
...
| `DurableAttemptLedger` | class | `src/engine/extraction/isolated_attempt_receipt.py:71` | 8 | unique |
...
| `_same_requirement` | function | `src/engine/extraction/opus_phase1_route.py:121` | 0 | unique |
...
| `extract_spine_condition_texts` | function | `src/engine/extraction/pilot_conveyor.py:303` | 8 | unique |
...
| `prepare_strategy` | function | `src/engine/extraction/pilot_conveyor.py:1133` | 4 | unique |
...
| `finalize_certificate` | function | `src/engine/extraction/pilot_conveyor.py:1502` | 6 | unique |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 218 | AMBIG |
...
| `check_condition_fidelity` | function | `src/engine/extraction/source_fidelity_guard.py:230` | 2 | unique |
...
| `adjudicate_locations` | function | `src/engine/extraction/span_collision.py:140` | 4 | unique |
...
| `_spec_hash` | function | `src/engine/extraction/spec_producer.py:758` | 1 | unique |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 218 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 218 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 218 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 218 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 218 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 218 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 218 | AMBIG |
...
| `TimeframeRoleBinding` | class | `src/engine/source_timeframe_roles.py:102` | 1 | AMBIG |
| `_exact_keys` | function | `src/engine/source_timeframe_roles.py:144` | 1 | AMBIG |
| `SourceTimeframeRoles` | class | `src/engine/source_timeframe_roles.py:158` | 3 | unique |
...
| `main` | function | `src/engine/stress_test.py:191` | 218 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 218 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 218 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 218 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 218 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 218 | AMBIG |
...
| `strategies` | const | `src/server/db/schema.ts:58` | 151 | AMBIG |
...
| `Span` | interface | `src/server/lib/tracing.ts:35` | 3 | AMBIG |
