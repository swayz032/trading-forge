...
> Generated at commit `6712d6952741ef2afcb527a3130c28d362488ff8`
...
Total entry points: **239**.  Modules reachable from them: **795** of **2260** parsed files.
...
| C5 | server entry point discovered | PASS | entry points discovered=239 |
| C6 | a registered route module is reachable | PASS | modules reachable=795 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=239 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 255 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 255 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 255 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 255 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 255 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 255 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 255 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 255 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 255 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 255 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 255 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 255 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 255 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 255 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 255 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 255 | AMBIG |
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 83 | unique |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 255 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 255 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 255 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 255 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 255 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 255 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 255 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 255 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 255 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 255 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 255 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 255 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 255 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 255 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 255 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 255 | AMBIG |
