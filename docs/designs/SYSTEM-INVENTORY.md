...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 316 | 414 | 131432 | 2049 |
...
|---|---:|---|
| Python class methods | 464 | one row per method would swamp the map; a method is reached through its class |
...
Total entry points: **245**.  Modules reachable from them: **802** of **2276** parsed files.

<details><summary>All 245 entry points and why each was counted</summary>

| Entry point | Discovered because |
|---|---|
| `scripts/_gpt_strategy_factory_gpt56_semantic_audit_ar1378a_repair_proof.py` | has `__main__` guard (runnable module) |
| `scripts/_gpt_strategy_factory_gpt56_semantic_audit_ar1379a_v2_contract_binding_proof.py` | has `__main__` guard (runnable module) |
| `scripts/_gpt_strategy_factory_gpt56_semantic_audit_grader_response_proof.py` | has `__main__` guard (runnable module) |
| `scripts/_gpt_strategy_factory_gpt56_semantic_audit_proof.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_build_reconstruction_tasks.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_emit_gpt56_calibration_tasks.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_emit_gpt56_round2_tasks.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_emit_gpt56_round3_e8_task.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_emit_gpt56_round3_e8_task_v2.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_freeze_fresh_opus_file_first.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_freeze_fresh_opus_round3_e8.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_freeze_self_authored_reconstruction.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_ingest_gpt56_response.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_ingest_gpt56_response_round2.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_novel_attack_lane_a_permit_replay_recandidate.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_novel_attack_lane_b_ht_fabrication.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_raw_to_canonical_proof.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_reattack_lane_a_post_repair.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_reattack_lane_b_post_repair.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_vi_e8_contact_sheet.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_vi_e8_generate_magnifications.py` | has `__main__` guard (runnable module) |
| `scripts/_worker_vi_e8_hash_manifest.py` | has `__main__` guard (runnable module) |
...
| `scripts/ar1283_identity_seam.py` | has `__main__` guard (runnable module) |
| `scripts/ar1320b_rival_role_confound_measurement_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/ar1321a_projection_controls_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/ar1321a_source_graph_projection_driver_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/ar1322a_source_graph_projection_v2_driver_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/ar1398_attack_replay.py` | has `__main__` guard (runnable module) |
...
| `scripts/control-plane-bootstrap/materialize-g2-prompt-transport.py` | has `__main__` guard (runnable module) |
...
| `scripts/g2d_ar1313_attribution_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_ar1313_regrade_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_ar1313b_text_correction_regrade_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_bridge_report.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_freeze_native_calls.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_lane1_deterministic_grade_tmp.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_postcall_capture.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_postcall_lifecycle.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_precall_transition.py` | has `__main__` guard (runnable module) |
| `scripts/g2d_real_queue_preflight.py` | has `__main__` guard (runnable module) |
| `scripts/g2h_population_drift_probe.py` | has `__main__` guard (runnable module) |
...
| `scripts/receipt_order_sensitivity_probe.py` | has `__main__` guard (runnable module) |
| `scripts/receipt_seed_matrix_probe.py` | has `__main__` guard (runnable module) |
...
| `scripts/source_graph_projection_v2_1_certify.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_gpt56_semantic_audit.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_manifest_row_projection.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_manifest_snapshot.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_opus_batch_locator.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_pilot_b.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_pilot_c_full_run.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_prep_provenance_inventory.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_prepare_and_finalize.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_probe_certification.py` | has `__main__` guard (runnable module) |
| `scripts/strategy_factory_run_extraction.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_build_blind_support_packet.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_freeze_isolated_queue.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_grade_phase1.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_grade_phase2_certificate.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_grade_v2_prescreen.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_laneA_locator_binding_diagnostic.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_laneB_stop_geometry_context.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_locator_benchmark.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_locator_reissue_v2.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_opus_batch_locator.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_stopA_direction_probe.py` | has `__main__` guard (runnable module) |
| `scripts/svkm_stop_ceiling_witness.py` | has `__main__` guard (runnable module) |
...
| `src/engine/extraction/svkm_v2_1_compile.py` | has `__main__` guard (runnable module) |
...
| C2 | WIRED is reachable by the classifier | PASS | WIRED=3809 |
| C3 | BUILT-UNREACHABLE is reachable by the classifier | PASS | BUILT-UNREACHABLE=1167 |
| C4 | result is not uniform (broken-probe tell) | PASS | largest bucket = 75.7% of 5035 rows |
| C5 | server entry point discovered | PASS | entry points discovered=245 |
| C6 | a registered route module is reachable | PASS | modules reachable=802 |
...
| C12 | symbols enumerated in both languages | PASS | py=2049 ts=2933 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=245 |
...
* **Name collision biases toward `WIRED` - and the affected population is MEASURED, not
  ...
  **222 of 4710 enumerated symbol names (4.7%) are defined in more than one file, covering
  494 of 4982 symbol rows (9.9%).**  Every symbol table below marks those rows `AMBIG`.
...
| `scripts/_worker_novel_attack_lane_a_permit_replay_recandidate.py` | 0 | 0 | 0 | 1 | 0 | 1 |
| `scripts/_worker_reattack_lane_a_post_repair.py` | 0 | 0 | 0 | 1 | 0 | 1 |
...
| `scripts/ratify1_controls/redproof_child_validity.py` | 0 | 0 | 0 | 1 | 0 | 1 |
...
| `src/engine/backtester.py` | 63 | 0 | 2 | 0 | 0 | 65 |
...
| `src/engine/context` | 111 | 2 | 10 | 0 | 0 | 123 |
...
| `src/engine/extraction` | 358 | 0 | 45 | 0 | 0 | 403 |
...
| `src/engine/opening_range_lowering.py` | 10 | 0 | 0 | 0 | 0 | 10 |
...
**46 rows.**  Two probes feed this: unresolvable internal import specifiers, and
...
| `scripts/strategy_factory_opus_bound_grade_compare.py` | path-literal | `scripts/_worker_novel_attack_lane_a_permit_replay_recandidate.py:49` | repo-relative path literal with no file on disk |
| `scripts/strategy_factory_opus_bound_grade_compare.py` | path-literal | `scripts/_worker_reattack_lane_a_post_repair.py:34` | repo-relative path literal with no file on disk |
...
| `src/engine/tests/NO_SUCH_FILE.py` | path-literal | `scripts/ratify1_controls/redproof_child_validity.py:65` | repo-relative path literal with no file on disk |
...
| `scripts/claude-rung-v32/shakedown_specs/-igpOZs8LsM__s0.spec.json` | path-literal | `src/engine/tests/test_c1_role_binding.py:44` | repo-relative path literal with no file on disk |
...
Of **1167** `BUILT-UNREACHABLE` symbols, **623 have test coverage but no production caller**.
...
| `validate_candidate_authority` | function | `src/engine/backtester.py:9854` | 1 | unique |
...
| `assert_sequential_interlock` | function | `src/engine/extraction/g2d_subagentstop_capture.py:316` | 1 | unique |
...
_...323 more omitted from this table._
...
| Symbol | Kind | Defined at | Reason |
|---|---|---|---|
| `shift_higher_tf_columns` | function | `src/engine/backtester.py:2571` | no non-test reference outside its own definition |
| `validate_candidate_authority` | function | `src/engine/backtester.py:9854` | no non-test reference outside its own definition; 1 test file(s) do reference it |
...
| Symbol | Kind | Defined at | Reason |
|---|---|---|---|
| `determinism_test` | function | `src/engine/cross_validation.py:263` | no non-test reference outside its own definition |
...
<details><summary><code>src/engine/extraction</code> - 45 symbols</summary>
...
| `assert_sequential_interlock` | function | `src/engine/extraction/g2d_subagentstop_capture.py:316` | no non-test reference outside its own definition; 1 test file(s) do reference it |
...
<details><summary><code>src/engine/trade_status.py</code> - 1 symbols</summary>

| Symbol | Kind | Defined at | Reason |
|---|---|---|---|
| `split_closed_open` | function | `src/engine/trade_status.py:45` | no non-test reference outside its own definition |
...
| `SOURCE_TIMEFRAME_ROLE_NAMES` | const | `src/server/services/spec-onboarding-service.ts:227` | defining module is not reachable from any measured entry point |
| `TimeframeRoleBinding` | interface | `src/server/services/spec-onboarding-service.ts:234` | defining module is not reachable from any measured entry point |
| `SourceTimeframeRolesEnvelope` | interface | `src/server/services/spec-onboarding-service.ts:242` | defining module is not reachable from any measured entry point |
| `parseSourceTimeframeRoles` | function | `src/server/services/spec-onboarding-service.ts:256` | defining module is not reachable from any measured entry point |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 260 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 260 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 260 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 260 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 260 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 260 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 260 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 260 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 260 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 260 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 260 | AMBIG |
...
| `client` | export-binding | `src/discord/bot.ts:692` | 23 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 260 | AMBIG |
...
<details><summary><code>src/engine/backtester.py</code> - 63 symbols</summary>

| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `_dst_us_rule_offset` | function | `src/engine/backtester.py:124` | 0 | unique |
| `_dst_correct_et_hour` | function | `src/engine/backtester.py:163` | 0 | unique |
| `_et_time_ge_flatten` | function | `src/engine/backtester.py:221` | 0 | unique |
| `apply_eligibility_gate` | function | `src/engine/backtester.py:248` | 0 | unique |
| `_build_eligibility_gate_mode_disclosure` | function | `src/engine/backtester.py:667` | 0 | unique |
| `_backtest_skip_signals_for_day` | function | `src/engine/backtester.py:716` | 0 | unique |
| `_load_anti_setups_for_strategy` | function | `src/engine/backtester.py:757` | 0 | unique |
| `_apply_backtest_parity_gates` | function | `src/engine/backtester.py:762` | 0 | unique |
| `_apply_naked_management` | function | `src/engine/backtester.py:1060` | 0 | unique |
| `_resolve_source_managed_exit` | function | `src/engine/backtester.py:1173` | 0 | unique |
| `_apply_source_fixed_r_management` | function | `src/engine/backtester.py:1281` | 0 | unique |
| `_apply_stop_only_management` | function | `src/engine/backtester.py:1386` | 0 | unique |
| `_apply_trade_management` | function | `src/engine/backtester.py:1531` | 1 | unique |
| `_apply_static_styleC_management` | function | `src/engine/backtester.py:1655` | 0 | unique |
| `_apply_adaptive_management` | function | `src/engine/backtester.py:2168` | 0 | unique |
| `_resolve_freq` | function | `src/engine/backtester.py:2622` | 0 | unique |
| `_extract_atr_period` | function | `src/engine/backtester.py:2627` | 0 | unique |
| `_compute_daily_pnls` | function | `src/engine/backtester.py:2635` | 0 | unique |
| `_compute_monthly_returns` | function | `src/engine/backtester.py:2776` | 0 | unique |
| `_aggregate_equity_daily` | function | `src/engine/backtester.py:2827` | 0 | unique |
| `_detect_dst_transitions` | function | `src/engine/backtester.py:2905` | 0 | unique |
| `_wilson_ci` | function | `src/engine/backtester.py:2941` | 0 | unique |
| `_compute_long_short_split` | function | `src/engine/backtester.py:2952` | 0 | unique |
| `_validate_bar_count` | function | `src/engine/backtester.py:3034` | 0 | unique |
| `_build_run_receipt` | function | `src/engine/backtester.py:3065` | 0 | unique |
| `_apply_max_trades_per_day` | function | `src/engine/backtester.py:3130` | 0 | unique |
| `_symbol_of_spec` | function | `src/engine/backtester.py:3283` | 0 | unique |
| `_get_stop_ceiling_for_symbol` | function | `src/engine/backtester.py:3295` | 1 | unique |
| `_source_risk_mode_from_spec` | function | `src/engine/backtester.py:3343` | 0 | unique |
| `_supply_opening_range_source_frame` | function | `src/engine/backtester.py:3374` | 0 | unique |
| `_bind_source_timeframe_roles` | function | `src/engine/backtester.py:3451` | 0 | unique |
| `_resolve_source_timeframe_roles` | function | `src/engine/backtester.py:3495` | 0 | unique |
| `_resolve_source_fixed_r` | function | `src/engine/backtester.py:3543` | 0 | unique |
| `_build_source_stop_map` | function | `src/engine/backtester.py:3587` | 0 | unique |
| `_structural_stop_parity_enabled` | function | `src/engine/backtester.py:3682` | 0 | unique |
| `_resolve_stop_risk_points` | function | `src/engine/backtester.py:3697` | 0 | unique |
| `_get_stop_floor_for_symbol` | function | `src/engine/backtester.py:3805` | 0 | unique |
| `_parse_slippage_survival_multiples` | function | `src/engine/backtester.py:3842` | 0 | unique |
| `_parse_slippage_survival_min_pf` | function | `src/engine/backtester.py:3862` | 0 | unique |
| `_parse_slippage_survival_min_trades` | function | `src/engine/backtester.py:3878` | 0 | unique |
| `_compute_slippage_survival_block` | function | `src/engine/backtester.py:3893` | 1 | unique |
| `_apply_dsl_stop_loss_and_time_stop` | function | `src/engine/backtester.py:3964` | 0 | unique |
| `_apply_source_faithful_occupancy` | function | `src/engine/backtester.py:4236` | 0 | unique |
| `_apply_dll_halt_to_entries` | function | `src/engine/backtester.py:4415` | 0 | unique |
| `partition_realized_open` | function | `src/engine/backtester.py:4553` | 0 | unique |
| `run_backtest` | function | `src/engine/backtester.py:4610` | 10 | unique |
| `_build_expected_signals_from_trades` | function | `src/engine/backtester.py:7235` | 0 | unique |
| `_execution_was_refused` | function | `src/engine/backtester.py:7309` | 0 | unique |
| `_emit_validated_result` | function | `src/engine/backtester.py:7347` | 0 | unique |
| `_compute_recovery_days_from_max_dd` | function | `src/engine/backtester.py:7417` | 0 | unique |
| `_compute_monthly_survival_stats` | function | `src/engine/backtester.py:7465` | 0 | unique |
| `_compute_tier` | function | `src/engine/backtester.py:7502` | 0 | unique |
| `_compute_forge_score` | function | `src/engine/backtester.py:7526` | 0 | unique |
| `compute_recency_weighted_score` | function | `src/engine/backtester.py:7553` | 0 | unique |
| `_empty_result` | function | `src/engine/backtester.py:7639` | 1 | AMBIG |
| `run_class_backtest` | function | `src/engine/backtester.py:7670` | 7 | unique |
| `_compute_decay_analysis` | function | `src/engine/backtester.py:9543` | 0 | unique |
| `_load_strategy_class` | function | `src/engine/backtester.py:9568` | 1 | unique |
| `_unevaluated_crisis_sentinel` | function | `src/engine/backtester.py:9587` | 0 | unique |
...
| `main` | function | `src/engine/backtester.py:9888` | 260 | AMBIG |
...
<details><summary><code>src/engine/context</code> - 111 symbols</summary>
...
| `evaluate_framework_risk` | function | `src/engine/context/framework_refusal.py:45` | 2 | unique |
...
| `SourceEntryEvent` | class | `src/engine/context/source_entry_events.py:87` | 0 | unique |
| `find_breakout_events` | function | `src/engine/context/source_entry_events.py:124` | 0 | unique |
| `_zone_is_outside` | function | `src/engine/context/source_entry_events.py:167` | 0 | unique |
| `select_source_entry_events` | function | `src/engine/context/source_entry_events.py:182` | 0 | unique |
| `source_stop_price` | function | `src/engine/context/source_entry_events.py:244` | 1 | unique |
| `SourceSessionRange` | class | `src/engine/context/source_entry_events.py:295` | 1 | unique |
| `SourceEventRecord` | class | `src/engine/context/source_entry_events.py:344` | 1 | unique |
| `select_session_source_events` | function | `src/engine/context/source_entry_events.py:395` | 1 | unique |
...
| `compute_structural_stop` | function | `src/engine/context/structural_stops.py:203` | 5 | unique |
...
| `main` | function | `src/engine/context_runner.py:317` | 260 | AMBIG |
...
| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `get_wfe_hard_floor` | function | `src/engine/cross_validation.py:36` | 1 | unique |
| `get_wfe_warn_floor` | function | `src/engine/cross_validation.py:44` | 1 | unique |
| `compute_wfe` | function | `src/engine/cross_validation.py:52` | 1 | unique |
| `bootstrap_ci` | function | `src/engine/cross_validation.py:108` | 0 | unique |
| `deflated_sharpe_ratio` | function | `src/engine/cross_validation.py:159` | 1 | unique |
| `compute_sortino_ratio` | function | `src/engine/cross_validation.py:301` | 0 | unique |
| `run_cross_validation` | function | `src/engine/cross_validation.py:318` | 2 | unique |
| `_verify_metrics` | function | `src/engine/cross_validation.py:377` | 0 | unique |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 260 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 260 | AMBIG |
...
<details><summary><code>src/engine/extraction</code> - 358 symbols</summary>
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 89 | unique |
...
| `screen_task_for_leakage` | function | `src/engine/extraction/batch_locator.py:174` | 1 | unique |
| `screen_is_live` | function | `src/engine/extraction/batch_locator.py:199` | 1 | unique |
| `parse_batch_return` | function | `src/engine/extraction/batch_locator.py:220` | 2 | unique |
| `verify_answer` | function | `src/engine/extraction/batch_locator.py:258` | 5 | unique |
| `verify_trial` | function | `src/engine/extraction/batch_locator.py:270` | 1 | unique |
| `stability` | function | `src/engine/extraction/batch_locator.py:286` | 4 | unique |
| `_overlap_fraction` | function | `src/engine/extraction/batch_locator.py:328` | 0 | unique |
| `compare_to_reference` | function | `src/engine/extraction/batch_locator.py:335` | 1 | unique |
| `Tier3Verdict` | class | `src/engine/extraction/cert_assembler.py:72` | 3 | unique |
...
| `SeamRefusal` | class | `src/engine/extraction/cert_identity_seam.py:85` | 1 | unique |
| `RouteIdentity` | class | `src/engine/extraction/cert_identity_seam.py:95` | 0 | unique |
| `bind_route_identities` | function | `src/engine/extraction/cert_identity_seam.py:110` | 1 | unique |
| `assert_certifiable_final_route` | function | `src/engine/extraction/cert_identity_seam.py:153` | 1 | unique |
| `make_identity_propose_fn` | function | `src/engine/extraction/cert_identity_seam.py:221` | 1 | unique |
| `verify_anchor_identity` | function | `src/engine/extraction/cert_identity_seam.py:257` | 1 | unique |
| `assert_identity_preserved` | function | `src/engine/extraction/cert_identity_seam.py:302` | 1 | unique |
| `CompileAuthorityError` | class | `src/engine/extraction/compile_authority.py:92` | 1 | unique |
| `RequiredDependency` | class | `src/engine/extraction/compile_authority.py:103` | 1 | unique |
| `CompileAuthority` | class | `src/engine/extraction/compile_authority.py:123` | 2 | unique |
| `validate_dependency_record` | function | `src/engine/extraction/compile_authority.py:192` | 0 | unique |
| `enforce_compile_authority` | function | `src/engine/extraction/compile_authority.py:278` | 1 | unique |
...
| `compile_record_to_artifact` | function | `src/engine/extraction/compile_certified_record.py:193` | 1 | unique |
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 260 | AMBIG |
...
| `Span` | class | `src/engine/extraction/evidence_antecedent.py:52` | 4 | AMBIG |
...
| `bind_qualifier_to_antecedent` | function | `src/engine/extraction/evidence_antecedent.py:78` | 3 | unique |
| `RelevanceVerdict` | class | `src/engine/extraction/evidence_relevance.py:57` | 0 | unique |
| `_terms` | function | `src/engine/extraction/evidence_relevance.py:66` | 2 | unique |
| `_weights` | function | `src/engine/extraction/evidence_relevance.py:91` | 1 | unique |
| `_stable_sum` | function | `src/engine/extraction/evidence_relevance.py:112` | 0 | unique |
| `_score` | function | `src/engine/extraction/evidence_relevance.py:142` | 1 | unique |
| `evaluate_evidence_relevance` | function | `src/engine/extraction/evidence_relevance.py:159` | 9 | unique |
| `RealExtractorError` | class | `src/engine/extraction/extractor_bridge.py:75` | 4 | unique |
...
| `get_or_extract` | function | `src/engine/extraction/extractor_bridge.py:368` | 2 | unique |
| `run_dry_run_real_extractor` | function | `src/engine/extraction/extractor_bridge.py:414` | 0 | unique |
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 260 | AMBIG |
| `SubagentStopNotTerminal` | class | `src/engine/extraction/g2d_subagentstop_capture.py:102` | 1 | unique |
| `_launch_ack_path` | function | `src/engine/extraction/g2d_subagentstop_capture.py:110` | 0 | unique |
| `record_async_launch_ack` | function | `src/engine/extraction/g2d_subagentstop_capture.py:114` | 1 | unique |
| `_read_launch_ack` | function | `src/engine/extraction/g2d_subagentstop_capture.py:161` | 0 | unique |
| `extract_subagent_stop_fields` | function | `src/engine/extraction/g2d_subagentstop_capture.py:169` | 0 | unique |
| `_subagent_stop_event_path` | function | `src/engine/extraction/g2d_subagentstop_capture.py:222` | 0 | unique |
| `_validate_launch_ack_identity` | function | `src/engine/extraction/g2d_subagentstop_capture.py:226` | 0 | unique |
| `capture_subagent_stop_event` | function | `src/engine/extraction/g2d_subagentstop_capture.py:248` | 1 | unique |
| `capture_subagent_stop_final` | function | `src/engine/extraction/g2d_subagentstop_capture.py:298` | 0 | unique |
| `AttemptRefused` | class | `src/engine/extraction/isolated_attempt_receipt.py:50` | 5 | unique |
| `_sha_bytes` | function | `src/engine/extraction/isolated_attempt_receipt.py:55` | 1 | unique |
| `_safe_name` | function | `src/engine/extraction/isolated_attempt_receipt.py:59` | 5 | unique |
| `DurableAttemptLedger` | class | `src/engine/extraction/isolated_attempt_receipt.py:71` | 9 | unique |
| `_dispatch_path` | function | `src/engine/extraction/isolated_bridge.py:103` | 0 | unique |
| `_completion_path` | function | `src/engine/extraction/isolated_bridge.py:107` | 0 | unique |
| `state_of` | function | `src/engine/extraction/isolated_bridge.py:111` | 2 | unique |
| `record_native_dispatch` | function | `src/engine/extraction/isolated_bridge.py:133` | 1 | unique |
| `capture_native_return` | function | `src/engine/extraction/isolated_bridge.py:192` | 2 | unique |
| `bridge_report` | function | `src/engine/extraction/isolated_bridge.py:291` | 1 | unique |
| `_sha` | function | `src/engine/extraction/isolated_fallback_law.py:71` | 4 | AMBIG |
| `FrozenQueue` | class | `src/engine/extraction/isolated_fallback_law.py:76` | 0 | unique |
| `freeze_isolated_queue` | function | `src/engine/extraction/isolated_fallback_law.py:100` | 1 | unique |
| `ConditionOutcome` | class | `src/engine/extraction/opus_phase1_route.py:91` | 0 | unique |
| `_content_terms` | function | `src/engine/extraction/opus_phase1_route.py:115` | 0 | unique |
| `_same_requirement` | function | `src/engine/extraction/opus_phase1_route.py:121` | 1 | unique |
| `_validate_composition_specs` | function | `src/engine/extraction/opus_phase1_route.py:129` | 1 | unique |
...
| `extract_spine_condition_texts` | function | `src/engine/extraction/pilot_conveyor.py:303` | 9 | unique |
...
| `extractor_version_pin` | function | `src/engine/extraction/pilot_conveyor.py:538` | 6 | unique |
...
| `support_verdict_from_stage2_response` | function | `src/engine/extraction/pilot_conveyor.py:1398` | 3 | unique |
| `diagnose_certificate` | function | `src/engine/extraction/pilot_conveyor.py:1439` | 1 | unique |
| `finalize_certificate` | function | `src/engine/extraction/pilot_conveyor.py:1502` | 7 | unique |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 260 | AMBIG |
...
| `FidelityFinding` | class | `src/engine/extraction/source_fidelity_guard.py:53` | 0 | unique |
| `_norm` | function | `src/engine/extraction/source_fidelity_guard.py:153` | 2 | AMBIG |
| `_has_certainty` | function | `src/engine/extraction/source_fidelity_guard.py:157` | 0 | unique |
| `_has_hedge` | function | `src/engine/extraction/source_fidelity_guard.py:165` | 0 | unique |
| `_content_words` | function | `src/engine/extraction/source_fidelity_guard.py:173` | 0 | unique |
| `_clauses` | function | `src/engine/extraction/source_fidelity_guard.py:179` | 0 | unique |
...
| `AliasSpec` | class | `src/engine/extraction/source_graph_projection.py:219` | 4 | unique |
| `GraphEdge` | class | `src/engine/extraction/source_graph_projection.py:226` | 2 | unique |
| `ExternalDependencySpec` | class | `src/engine/extraction/source_graph_projection.py:233` | 4 | unique |
| `_canonical_json_sha256` | function | `src/engine/extraction/source_graph_projection.py:269` | 0 | unique |
| `external_dependency_contract_hash` | function | `src/engine/extraction/source_graph_projection.py:285` | 2 | unique |
| `ProjectionSpec` | class | `src/engine/extraction/source_graph_projection.py:302` | 4 | unique |
| `_claim_role` | function | `src/engine/extraction/source_graph_projection.py:333` | 1 | unique |
| `_eligible_for_preserved_metadata` | function | `src/engine/extraction/source_graph_projection.py:358` | 0 | unique |
| `_sha256` | function | `src/engine/extraction/source_graph_projection.py:369` | 4 | AMBIG |
| `_validate_preserved_metadata_schema` | function | `src/engine/extraction/source_graph_projection.py:384` | 0 | unique |
...
| `detect_span_collisions` | function | `src/engine/extraction/span_collision.py:63` | 2 | unique |
| `adjudicate_locations` | function | `src/engine/extraction/span_collision.py:140` | 5 | unique |
| `summarise` | function | `src/engine/extraction/span_collision.py:207` | 3 | unique |
| `_stem_pattern` | function | `src/engine/extraction/spec_producer.py:235` | 0 | unique |
| `_norm` | function | `src/engine/extraction/spec_producer.py:255` | 2 | AMBIG |
| `_slug` | function | `src/engine/extraction/spec_producer.py:259` | 3 | unique |
| `_family_evidence` | function | `src/engine/extraction/spec_producer.py:264` | 0 | unique |
| `_classify_family` | function | `src/engine/extraction/spec_producer.py:356` | 0 | unique |
| `_direction` | function | `src/engine/extraction/spec_producer.py:423` | 0 | unique |
| `_condition_text` | function | `src/engine/extraction/spec_producer.py:428` | 0 | unique |
| `_concrete_stop` | function | `src/engine/extraction/spec_producer.py:444` | 0 | unique |
| `_concrete_target` | function | `src/engine/extraction/spec_producer.py:476` | 0 | unique |
| `_untaught_exit` | function | `src/engine/extraction/spec_producer.py:496` | 0 | unique |
| `_anchor_grounds` | function | `src/engine/extraction/spec_producer.py:544` | 0 | unique |
| `_cert_span_for` | function | `src/engine/extraction/spec_producer.py:557` | 0 | unique |
| `_entry_condition` | function | `src/engine/extraction/spec_producer.py:589` | 0 | unique |
| `_spec_role` | function | `src/engine/extraction/spec_producer.py:623` | 0 | unique |
| `produce_spec_artifact` | function | `src/engine/extraction/spec_producer.py:645` | 0 | unique |
| `_spec_hash` | function | `src/engine/extraction/spec_producer.py:758` | 2 | unique |
| `_approximation_metrics` | function | `src/engine/extraction/spec_producer.py:763` | 0 | unique |
| `_all_strings` | function | `src/engine/extraction/spec_producer.py:832` | 0 | unique |
...
| `CanonicalNodeNotAcceptedError` | class | `src/engine/extraction/svkm_v2_1_compile.py:153` | 0 | unique |
| `_bench` | function | `src/engine/extraction/svkm_v2_1_compile.py:159` | 3 | unique |
| `_canonical_hash` | function | `src/engine/extraction/svkm_v2_1_compile.py:174` | 1 | unique |
| `run_certified_projection` | function | `src/engine/extraction/svkm_v2_1_compile.py:184` | 1 | unique |
| `stamp_receipt` | function | `src/engine/extraction/svkm_v2_1_compile.py:215` | 2 | unique |
| `_outcome_by_ref` | function | `src/engine/extraction/svkm_v2_1_compile.py:233` | 0 | unique |
| `_projected_text` | function | `src/engine/extraction/svkm_v2_1_compile.py:237` | 0 | unique |
| `_derived_dependency_blockers` | function | `src/engine/extraction/svkm_v2_1_compile.py:262` | 0 | unique |
| `_refuse_if_receipt_hash_broken` | function | `src/engine/extraction/svkm_v2_1_compile.py:311` | 0 | unique |
| `_refuse_if_not_compile_ready` | function | `src/engine/extraction/svkm_v2_1_compile.py:381` | 0 | unique |
| `build_certified_record` | function | `src/engine/extraction/svkm_v2_1_compile.py:538` | 1 | unique |
| `_preserved_metadata_text` | function | `src/engine/extraction/svkm_v2_1_compile.py:625` | 0 | unique |
| `_load_frozen_source_risk` | function | `src/engine/extraction/svkm_v2_1_compile.py:640` | 0 | unique |
| `_svkm_timeframe_roles` | function | `src/engine/extraction/svkm_v2_1_compile.py:669` | 0 | unique |
| `compile_svkm_v2_1_vertical` | function | `src/engine/extraction/svkm_v2_1_compile.py:731` | 2 | unique |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 260 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 260 | AMBIG |
...
| `_norm` | function | `src/engine/forensics/compile_fidelity.py:194` | 2 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 260 | AMBIG |
...
| `_check_commission_per_trade_reasonable` | function | `src/engine/invariant_harness/core.py:739` | 0 | unique |
| `_check_per_firm_endings` | function | `src/engine/invariant_harness/core.py:779` | 0 | unique |
| `_check_equity_curve_continuous` | function | `src/engine/invariant_harness/core.py:867` | 0 | unique |
| `InvariantHarness` | class | `src/engine/invariant_harness/core.py:950` | 1 | unique |
| `run_invariants` | function | `src/engine/invariant_harness/core.py:1008` | 2 | unique |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 260 | AMBIG |
...
| `_exact_keys` | function | `src/engine/opening_range_candidate_receipt.py:94` | 1 | AMBIG |
...
| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `OpeningRangeLoweringDisposition` | class | `src/engine/opening_range_lowering.py:74` | 0 | unique |
| `_duration_minutes` | function | `src/engine/opening_range_lowering.py:122` | 0 | unique |
| `_timezone_in` | function | `src/engine/opening_range_lowering.py:131` | 0 | unique |
| `_clock` | function | `src/engine/opening_range_lowering.py:143` | 0 | unique |
| `_taught_spans` | function | `src/engine/opening_range_lowering.py:159` | 0 | unique |
| `_VariantProblem` | class | `src/engine/opening_range_lowering.py:195` | 0 | unique |
| `_taught_variants` | function | `src/engine/opening_range_lowering.py:200` | 0 | unique |
| `OpeningRangeSourceRefusal` | class | `src/engine/opening_range_lowering.py:297` | 0 | unique |
| `OpeningRangeLoweringResult` | class | `src/engine/opening_range_lowering.py:352` | 1 | unique |
| `lower_opening_range_definition` | function | `src/engine/opening_range_lowering.py:367` | 1 | unique |
...
| `main` | function | `src/engine/regime.py:293` | 260 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 260 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 260 | AMBIG |
...
<details><summary><code>src/engine/source_timeframe_roles.py</code> - 4 symbols</summary>

| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `SourceTimeframeRoleError` | class | `src/engine/source_timeframe_roles.py:62` | 1 | unique |
| `TimeframeRoleBinding` | class | `src/engine/source_timeframe_roles.py:102` | 2 | AMBIG |
| `_exact_keys` | function | `src/engine/source_timeframe_roles.py:144` | 1 | AMBIG |
| `SourceTimeframeRoles` | class | `src/engine/source_timeframe_roles.py:158` | 4 | unique |
...
| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `_htf_fully_covers` | function | `src/engine/spec_condition_compiler.py:301` | 0 | unique |
| `retest_touch_check` | function | `src/engine/spec_condition_compiler.py:362` | 0 | unique |
| `_ffill_level_series` | function | `src/engine/spec_condition_compiler.py:390` | 0 | unique |
| `population_a_bullish_leaning` | function | `src/engine/spec_condition_compiler.py:410` | 0 | unique |
...
| `main` | function | `src/engine/stress_test.py:191` | 260 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 260 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 260 | AMBIG |
...
| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `SourceRoleExecutionError` | class | `src/engine/svkm_role_execution.py:86` | 2 | unique |
...
| `RoleFrame` | class | `src/engine/svkm_role_execution.py:161` | 2 | unique |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 260 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 260 | AMBIG |
...
| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `is_open_at_frame_end` | function | `src/engine/trade_status.py:20` | 2 | unique |
...
| `main` | function | `src/engine/validation_runner.py:97` | 260 | AMBIG |
...
| Symbol | Kind | Defined at | Non-test caller files | Name |
|---|---|---|---:|---|
| `client` | const | `src/server/db/index.ts:19` | 23 | AMBIG |
| `db` | const | `src/server/db/index.ts:34` | 272 | unique |
...
| `strategies` | const | `src/server/db/schema.ts:58` | 157 | AMBIG |
...
| `Span` | interface | `src/server/lib/tracing.ts:35` | 4 | AMBIG |
