...
> Generated at commit `3cc852fdd904284022e785d06a9203f6ec867cdc`  (worktree DIRTY at generation time)
...
Total entry points: **217**.  Modules reachable from them: **773** of **2229** parsed files.

<details><summary>All 217 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=217 |
| C6 | a registered route module is reachable | PASS | modules reachable=773 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=217 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 232 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 232 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 232 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 232 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 232 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 232 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 232 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 232 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 232 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 232 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 232 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 232 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 232 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 232 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 232 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 232 | AMBIG |
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 68 | unique |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 232 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 232 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 232 | AMBIG |
...
| `run_projection` | function | `src/engine/extraction/source_graph_projection.py:428` | 5 | unique |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 232 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 232 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 232 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 232 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 232 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 232 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 232 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 232 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 232 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 232 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 232 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 232 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 232 | AMBIG |
...
| `strategies` | const | `src/server/db/schema.ts:58` | 155 | AMBIG |
