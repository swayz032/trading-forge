...
> Generated at commit `3e301717dac14aab60b77d6c4f51b8b395f53029`
...
Total entry points: **212**.  Modules reachable from them: **768** of **2223** parsed files.

<details><summary>All 212 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=212 |
| C6 | a registered route module is reachable | PASS | modules reachable=768 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=212 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 227 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 227 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 227 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 227 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 227 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 227 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 227 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 227 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 227 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 227 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 227 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 227 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 227 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 227 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 227 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 227 | AMBIG |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 227 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 227 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 227 | AMBIG |
...
| `compile_svkm_v2_1_vertical` | function | `src/engine/extraction/svkm_v2_1_compile.py:395` | 1 | unique |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 227 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 227 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 227 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 227 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 227 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 227 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 227 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 227 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 227 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 227 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 227 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 227 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 227 | AMBIG |
...
| `strategies` | const | `src/server/db/schema.ts:58` | 152 | AMBIG |
