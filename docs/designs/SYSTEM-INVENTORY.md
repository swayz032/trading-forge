...
> Generated at commit `49a73728c671a52c5203c6f820446040332e31b7`
...
Total entry points: **213**.  Modules reachable from them: **769** of **2224** parsed files.

<details><summary>All 213 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=213 |
| C6 | a registered route module is reachable | PASS | modules reachable=769 |
| C7 | env-flag extractor fires in both languages | PASS | py files with env reads=129, ts=346 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=213 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 228 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 228 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 228 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 228 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 228 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 228 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 228 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 228 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 228 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 228 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 228 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 228 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 228 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 228 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 228 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 228 | AMBIG |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 228 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 228 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 228 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 228 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 228 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 228 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 228 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 228 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 228 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 228 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 228 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 228 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 228 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 228 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 228 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 228 | AMBIG |
