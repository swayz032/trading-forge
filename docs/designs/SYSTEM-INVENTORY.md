...
> Generated at commit `74f49f632d9adf670b0d250654498b89da3ebad3`  (worktree DIRTY at generation time)
...
|---|---|---:|---:|---:|---:|
| `src/` | Python | 297 | 388 | 124584 | 1918 |
...
| `src/` test files | 1113 | tests are the reference surface, never the symbol surface |
...
Total entry points: **180**.  Modules reachable from them: **721** of **2136** parsed files.
...
* **Name collision biases toward `WIRED` - and the affected population is MEASURED, not
  ...
  **219 of 4583 enumerated symbol names (4.8%) are defined in more than one file, covering
  487 of 4851 symbol rows (10.0%).**  Every symbol table below marks those rows `AMBIG`.
