...
> Generated at commit `2dcc8efac14bcf907ea21bab1ca3a295f107d03c`  (worktree DIRTY at generation time)
...
Total entry points: **186**.  Modules reachable from them: **732** of **2159** parsed files.
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=186 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 202 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 202 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 202 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 202 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 202 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 202 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 202 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 202 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 202 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 202 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 202 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 202 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 202 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 202 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 202 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 202 | AMBIG |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 202 | AMBIG |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 202 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 202 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 202 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 202 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 202 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 202 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 202 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 202 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 202 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 202 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 202 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 202 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 202 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 202 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 202 | AMBIG |
