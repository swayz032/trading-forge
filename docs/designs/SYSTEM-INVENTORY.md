...
> Generated at commit `4fc0f6f5e72a9fc1c17183007389abbee43a2d4d`  (worktree DIRTY at generation time)
...
Total entry points: **240**.  Modules reachable from them: **796** of **2265** parsed files.

<details><summary>All 240 entry points and why each was counted</summary>
...
| C5 | server entry point discovered | PASS | entry points discovered=240 |
| C6 | a registered route module is reachable | PASS | modules reachable=796 |
...
| C19 | `python -m` module-spec entry points are discovered | PASS | pine_compiler is an entry point=True; total entry points=240 |
...
| `main` | function | `src/data/scripts/adjust_continuous.py:128` | 256 | AMBIG |
...
| `main` | function | `src/data/scripts/crisis_data_download.py:188` | 256 | AMBIG |
| `run_step` | function | `src/data/scripts/crisis_pipeline.py:27` | 0 | unique |
| `main` | function | `src/data/scripts/crisis_pipeline.py:40` | 256 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_definition_pull.py:231` | 256 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_download.py:115` | 256 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_imbalance_pull.py:197` | 256 | AMBIG |
...
| `main` | function | `src/data/scripts/databento_statistics_pull.py:177` | 256 | AMBIG |
...
| `main` | function | `src/data/scripts/refresh_local_cache.py:608` | 256 | AMBIG |
| `resample` | function | `src/data/scripts/resample_timeframes.py:30` | 3 | unique |
| `main` | function | `src/data/scripts/resample_timeframes.py:46` | 256 | AMBIG |
| `run_script` | function | `src/data/scripts/run_pipeline.py:22` | 0 | unique |
| `main` | function | `src/data/scripts/run_pipeline.py:46` | 256 | AMBIG |
...
| `main` | function | `src/data/scripts/upload_to_s3.py:89` | 256 | AMBIG |
...
| `main` | function | `src/engine/archetype_evaluator.py:374` | 256 | AMBIG |
...
| `main` | function | `src/engine/backtester.py:9888` | 256 | AMBIG |
...
| `main` | function | `src/engine/context_runner.py:317` | 256 | AMBIG |
...
| `main` | function | `src/engine/deepar_forecaster.py:571` | 256 | AMBIG |
...
| `main` | function | `src/engine/deepar_regime_classifier.py:286` | 256 | AMBIG |
...
| `sha256` | function | `src/engine/extraction/batch_locator.py:76` | 85 | unique |
...
| `main` | function | `src/engine/extraction/compile_certified_record.py:250` | 256 | AMBIG |
...
| `_score` | function | `src/engine/extraction/evidence_relevance.py:111` | 0 | unique |
| `evaluate_evidence_relevance` | function | `src/engine/extraction/evidence_relevance.py:128` | 9 | unique |
...
| `main` | function | `src/engine/extraction/extractor_bridge.py:490` | 256 | AMBIG |
...
| `main` | function | `src/engine/extraction/pilot_conveyor.py:1882` | 256 | AMBIG |
...
| `CanonicalNodeNotAcceptedError` | class | `src/engine/extraction/svkm_v2_1_compile.py:138` | 0 | unique |
| `_bench` | function | `src/engine/extraction/svkm_v2_1_compile.py:144` | 1 | unique |
| `_canonical_hash` | function | `src/engine/extraction/svkm_v2_1_compile.py:159` | 1 | unique |
| `run_certified_projection` | function | `src/engine/extraction/svkm_v2_1_compile.py:169` | 0 | unique |
| `_outcome_by_ref` | function | `src/engine/extraction/svkm_v2_1_compile.py:187` | 0 | unique |
| `_projected_text` | function | `src/engine/extraction/svkm_v2_1_compile.py:191` | 0 | unique |
| `build_certified_record` | function | `src/engine/extraction/svkm_v2_1_compile.py:216` | 0 | unique |
| `_preserved_metadata_text` | function | `src/engine/extraction/svkm_v2_1_compile.py:289` | 0 | unique |
| `_load_frozen_source_risk` | function | `src/engine/extraction/svkm_v2_1_compile.py:304` | 0 | unique |
| `_svkm_timeframe_roles` | function | `src/engine/extraction/svkm_v2_1_compile.py:333` | 0 | unique |
| `compile_svkm_v2_1_vertical` | function | `src/engine/extraction/svkm_v2_1_compile.py:395` | 2 | unique |
...
| `main` | function | `src/engine/extraction/tier1_coverage_report.py:237` | 256 | AMBIG |
...
| `main` | function | `src/engine/extraction/tier2_design_report.py:394` | 256 | AMBIG |
...
| `main` | function | `src/engine/graveyard/cluster.py:119` | 256 | AMBIG |
...
| `main` | function | `src/engine/monte_carlo.py:2219` | 256 | AMBIG |
...
| `main` | function | `src/engine/regime.py:293` | 256 | AMBIG |
...
| `main` | function | `src/engine/replay/survival_twin_replay.py:640` | 256 | AMBIG |
...
| `main` | function | `src/engine/skip_engine/weight_trainer.py:268` | 256 | AMBIG |
...
| `main` | function | `src/engine/stress_test.py:191` | 256 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_comparator.py:124` | 256 | AMBIG |
...
| `main` | function | `src/engine/survival/survival_scorer.py:379` | 256 | AMBIG |
...
| `main` | function | `src/engine/synthetic/populate_regime_bank.py:382` | 256 | AMBIG |
...
| `main` | function | `src/engine/synthetic_market_simulator.py:1057` | 256 | AMBIG |
...
| `main` | function | `src/engine/validation_runner.py:97` | 256 | AMBIG |
