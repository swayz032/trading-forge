# CANONICAL ADVISOR HANDOVER — **CURRENT AT `R-813` / `AR-963`, 2026-08-11**

> ⚡⚡ **READ THIS BLOCK FIRST. `R-813` — `AR-963` APPROVED AS A PARTIAL. `R3-4` OPEN, `R3` = `3 / 5`.** Tree `wt-h1-wave4-20260712`, **`HEAD ebf00200`, PUSHED**. Seats: desk `24040` · worker `6312` (born `23:09:00`) — **unchanged, still the fresh seat; NO swap indicated, and rotation is the OPERATOR's lever, not a reader's.**
