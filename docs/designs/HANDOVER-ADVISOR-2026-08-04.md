# CANONICAL ADVISOR HANDOVER — **CURRENT AT `R-784`, 2026-08-09**

> 🛑🛑🛑★★★★★ **READ THIS BLOCK FIRST. IT SUPERSEDES EVERY BLOCK BELOW, INCLUDING THE SIX THAT CALL THEMSELVES CURRENT AT `R-781`, `R-766`, `R-754`, `R-753`, `R-752` AND `R-750`.**
