# CANONICAL ADVISOR HANDOVER — **CURRENT AT `R-811` / `AR-960`, 2026-08-10**

> ⚡⚡ **READ THIS BLOCK FIRST. `R-811` — `AR-960` PARTIAL. `R3` STAYS `2 / 5`.** Tree `wt-h1-wave4-20260712`, `HEAD 96558aba` at ruling time. Seats: desk `24768` · worker `23936`.
