...
> ObjLit    := "{" ( Key ":" Frozen ),* "}"
>              Key := Ident | StringLit,  Key != "__proto__" in EITHER spelling,
>                                         and all Keys in one ObjLit DISTINCT
...
⚠️★★★★★ **THIS MATRIX IS `52` MUTATIONS **PLUS** `1` CLEAN CONTROL — `53` NUMBERED ROWS, CONTIGUOUS `1..53`, ZERO DUPLICATES, CONTROL LAST.** `[COUNTED BY A SECTION-ANCHORED PARSE AFTER THE ROWS LANDED; NOT copied from any prior statement of the figure.]`
★★★★★ **NINTH RECOMPUTATION. The caption has read `23`, `22+1`, `24+1`, `29+1`, `32+1`, `33+1`, `42+1`, `47+1`, `49+1` and now `52+1`, each correct until the next rows landed.**
...
duplicate ordinary keys               Object.freeze({ a: 1, a: 2 })                 52
------------------------------------------------------------------------------------------
