...
⚠️★★★★★ **THIS MATRIX IS `49` MUTATIONS **PLUS** `1` CLEAN CONTROL — `50` NUMBERED ROWS, CONTIGUOUS `1..50`, ZERO DUPLICATES, CONTROL LAST.** `[COUNTED BY A SECTION-ANCHORED PARSE AFTER THE ROWS LANDED; NOT copied from any prior statement of the figure.]`
★★★★★ **EIGHTH RECOMPUTATION. The caption has read `23`, `22+1`, `24+1`, `29+1`, `32+1`, `33+1`, `42+1`, `47+1` and now `49+1`, each correct until the next rows landed.**
...
| **50** | **clean control — unmutated** | **GREEN**, with the frame, resolved scope and digest printed | all |
