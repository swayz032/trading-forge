...
⚠️★★★★★ **THIS MATRIX IS `53` MUTATIONS **PLUS** `1` CLEAN CONTROL — `54` NUMBERED ROWS, CONTIGUOUS `1..54`, ZERO DUPLICATES, CONTROL LAST.** `[COUNTED BY A SECTION-ANCHORED PARSE AFTER THE ROWS LANDED; NOT copied from any prior statement of the figure.]`
★★★★★ **TENTH RECOMPUTATION. The caption has read `23`, `22+1`, `24+1`, `29+1`, `32+1`, `33+1`, `42+1`, `47+1`, `49+1`, `52+1` and now `53+1`, each correct until the next rows landed.**
...
| **54** | **clean control — unmutated** | **GREEN**, with the frame, resolved scope and digest printed | all |
