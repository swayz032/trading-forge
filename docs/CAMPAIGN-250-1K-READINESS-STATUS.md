...
| **W2b** Sizing lowest-wins (C-05) | ⏳ **NEXT** | pin to `d694c61a`; remove healthy-account floor override (D9) — the 6 pre-existing pytest failures in wave22_firm_sizing/risk_derived_sizing ARE this bug |
