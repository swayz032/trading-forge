...
the thin current_mnq_strategy_v2_4_target_policy layer applies the direct trader
TP-display safe-gap and processed-reaction continuation rule identically to
