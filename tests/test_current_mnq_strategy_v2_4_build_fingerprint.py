...
def test_production_build_contract_covers_transitive_strategy_edge_data_and_execution_boundaries():
    ...
    required = {
        ...
        "research/current_mnq_strategy_v2_4_visual_evidence_manifest_2026_08_20.json",
        "research/current_mnq_strategy_v2_4_replay_calibration_requirements.json",
    ...
    assert b["schema_version"] == 13
    assert b["release_id"] == "MNQ-V2.4-BUILD-FINGERPRINT-13-CLOSED-WORLD-SR-FVG-CALREQ"
