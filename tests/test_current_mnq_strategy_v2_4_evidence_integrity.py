...
def test_architecture_gold_integrity_requires_exact_current_hashes():
    ...
    bad = dict(good)
    bad["v24_user_fidelity_gold_sha256"] = "0" * 64
...
def test_same_counts_cannot_rescue_wrong_manifest_hash(tmp_path):
    ...
    arch.write_text(json.dumps({
        ...
        "tests": 100,
        "failures": 0,
        "positive_user_gold_count": ev.gold_counts()[0],
        "real_user_tempting_no_trade_gold_count": ev.gold_counts()[1],
        "positive_user_gold_sha256": hashes["positive_user_gold_sha256"],
        "v24_user_fidelity_gold_sha256": "0" * 64,
        "tempting_no_trade_gold_sha256": hashes["tempting_no_trade_gold_sha256"],
    }))
