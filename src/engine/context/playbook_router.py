...
#
# F-4 registration (deep-scan #21 Band-B2 carry-forward, 2026-07-06): the 22
# hand-coded archetype classes in src/engine/strategies/*.py are a SEPARATE
# population from the 174-entry graduated DSL library. 7 of the 22 were never
# registered here, so their live signals took the "unregistered strategy
# bypass" in eligibility_gate.py::evaluate_signal (action=TAKE unconditionally,
# skipping ALL 9 hard-SKIP checks including the structural-stop-ceiling Check
# 0) and the mirror bypass in backtester.py::apply_eligibility_gate
# (passthrough_strategy_unregistered). Registering them here routes BOTH
# engines through the full 7-layer eligibility gate identically, closing the
# CRITICAL fail-open and preserving parity (both engines now apply the SAME
# checks to these 7, instead of both bypassing them identically-but-unsafely).
#
# Category assignment verified against each archetype's own entry-logic
# docstring in src/engine/strategies/<name>.py (do NOT re-guess without
# re-reading — a wrong category routes to the wrong per-playbook allow-list
# at eligibility_gate.py Check #2 and either SKIPs valid signals or ALLOWs
# wrong ones):
#   ict_bias_aligned_continuation, gann_box_4h_continuation -> CONTINUATION
#     (both explicitly BIDIRECTIONAL continuation setups: HTF-bias-aligned
#     BOS/CHoCH + FVG retest, and impulsive-candle Fib-zone retracement entry
#     with FVG/OB confluence — same "continuation" family as ote/ict_swing).
#   turtle_soup, smt_reversal, ict_2022, unicorn -> REVERSAL
#     (turtle_soup: canonical sweep-of-equal-H/L fade + MSS, same family as
#     the already-registered eqhl_raid/london_raid/judas_swing sweep-reversal
#     strategies; smt_reversal: literally named "reversal", cross-instrument
#     divergence + MSS; ict_2022: HTF bias + liquidity sweep + MSS-confirmed
#     reversal + FVG-at-OTE entry — matches SWEEP_REVERSAL_LONG/SHORT's own
#     "turtle_soup"/"sweep_reclaim" allowed_setups; unicorn: Breaker Block +
#     FVG overlap retrace entry — "breaker" is already a registered REVERSAL_
#     STRAT, unicorn is the breaker+FVG confluence variant of the same family).
#   bounce_off_level -> MEAN_REV
#     (docstring frames it explicitly as MA-as-S/R "rejection" behavior —
#     price touches a level and reverts away from it — matching
#     MEAN_REVERSION_LONG/SHORT's own "vwap_rejection"/"ob_rejection"
#     allowed_setups, not CONTINUATION's "vwap_reclaim"/"breakout_pullback").
# ---------------------------------------------------------------------------
CONTINUATION_STRATS = ["ote", "ict_swing", "propulsion", "power_of_3", "quarterly_swing", "silver_bullet", "ict_bias_aligned_continuation", "gann_box_4h_continuation", "5m_minute_support_level_mes_5m", "5m_minute_support_level_mnq_5m", "5m_minute_support_level_mcl_5m", "entry_chart_timeframe_mes_5m", "entry_chart_timeframe_mnq_5m", "entry_chart_timeframe_mcl_5m", "long_entry_or_short_entry_mes_5m", "long_entry_or_short_entry_mnq_5m", "long_entry_or_short_entry_mcl_5m", "look_i_use_range_breakouts_confirmation_trend_direction_mes_5m", "look_i_use_range_breakouts_confirmation_trend_direction_mnq_5m", "look_i_use_range_breakouts_confirmation_trend_direction_mcl_5m", "expansion_higher_mes_5m", "expansion_higher_mnq_5m", "expansion_higher_mcl_5m", "ballinger_bands_mes_5m", "ballinger_bands_mnq_5m", "ballinger_bands_mcl_5m", "momentum_build_in_real_time_mes_5m", "momentum_build_in_real_time_mnq_5m", "momentum_build_in_real_time_mcl_5m", "long_opportunities_mes_5m", "long_opportunities_mnq_5m", "long_opportunities_mcl_5m", "price_break_above_below_high_low_mes_5m", "price_break_above_below_high_low_mnq_5m", "price_break_above_below_high_low_mcl_5m", "short_position_mes_5m", "short_position_mnq_5m", "short_position_mcl_5m", "bullish_candle_formation_mes_5m", "bullish_candle_formation_mnq_5m", "bullish_candle_formation_mcl_5m", "buy_trades_in_counter_trend_trading_environment_mes_5m", "buy_trades_in_counter_trend_trading_environment_mnq_5m", "buy_trades_in_counter_trend_trading_environment_mcl_5m", "discount_price_to_buy_from_mes_5m", "discount_price_to_buy_from_mnq_5m", "discount_price_to_buy_from_mcl_5m", "ema_period_mes_5m", "ema_period_mnq_5m", "ema_period_mcl_5m", "price_break_mes_5m", "price_break_mnq_5m", "price_break_mcl_5m", "put_limit_order_right_fvg_mes_5m", "put_limit_order_right_fvg_mnq_5m", "put_limit_order_right_fvg_mcl_5m", "crossover_mes_5m", "crossover_mnq_5m", "crossover_mcl_5m", "avoiding_two_mistakes_mes_5m", "avoiding_two_mistakes_mnq_5m", "avoiding_two_mistakes_mcl_5m", "breakout_capture_mes_5m", "breakout_capture_mnq_5m", "breakout_capture_mcl_5m", "long_entry_mes_5m", "long_entry_mnq_5m", "long_entry_mcl_5m", "buying_opportunity_mes_5m", "buying_opportunity_mnq_5m", "buying_opportunity_mcl_5m", "long_entry_or_short_entry_mes_15m", "long_entry_or_short_entry_mnq_15m", "long_entry_or_short_entry_mcl_15m", "discount_price_to_buy_from_mes_30m", "discount_price_to_buy_from_mnq_30m", "discount_price_to_buy_from_mcl_30m", "long_opportunities_mes_4h", "long_opportunities_mnq_4h", "long_opportunities_mcl_4h", "buy_trades_in_counter_trend_trading_environment_mes_4h", "buy_trades_in_counter_trend_trading_environment_mnq_4h", "buy_trades_in_counter_trend_trading_environment_mcl_4h", "bullish_candle_formation_mes_1m", "bullish_candle_formation_mnq_1m", "bullish_candle_formation_mcl_1m", "avoiding_two_mistakes_mes_1m", "avoiding_two_mistakes_mnq_1m", "avoiding_two_mistakes_mcl_1m", "long_entry_mes_15m", "long_entry_mnq_15m", "long_entry_mcl_15m", "buying_opportunity_mes_15m", "buying_opportunity_mnq_15m", "buying_opportunity_mcl_15m"]
REVERSAL_STRATS = ["breaker", "eqhl_raid", "london_raid", "judas_swing", "mitigation", "turtle_soup", "smt_reversal", "ict_2022", "unicorn", "manipulation_trade_mes_5m", "manipulation_trade_mnq_5m", "manipulation_trade_mcl_5m", "overall_trend_mes_5m", "overall_trend_mnq_5m", "overall_trend_mcl_5m", "short_entry_mes_5m", "short_entry_mnq_5m", "short_entry_mcl_5m", "jump_in_downtrend_mes_5m", "jump_in_downtrend_mnq_5m", "jump_in_downtrend_mcl_5m", "bos_and_fvg_or_fvg_mes_5m", "bos_and_fvg_or_fvg_mnq_5m", "bos_and_fvg_or_fvg_mcl_5m", "retracement_opportunity_mes_5m", "retracement_opportunity_mnq_5m", "retracement_opportunity_mcl_5m", "trade_era_scale_in_mes_5m", "trade_era_scale_in_mnq_5m", "trade_era_scale_in_mcl_5m", "vwap_cross_mes_5m", "vwap_cross_mnq_5m", "vwap_cross_mcl_5m", "order_block_entry_trigger_mes_5m", "order_block_entry_trigger_mnq_5m", "order_block_entry_trigger_mcl_5m", "trading_session_time_mes_5m", "trading_session_time_mnq_5m", "trading_session_time_mcl_5m", "hammer_candle_long_side_mes_5m", "hammer_candle_long_side_mnq_5m", "hammer_candle_long_side_mcl_5m", "downside_delivery_mes_5m", "downside_delivery_mnq_5m", "downside_delivery_mcl_5m", "opening_range_breakout_orb_mes_5m", "opening_range_breakout_orb_mnq_5m", "opening_range_breakout_orb_mcl_5m", "entry_condition_mes_5m", "entry_condition_mnq_5m", "entry_condition_mcl_5m", "entry_at_key_levels_mes_5m", "entry_at_key_levels_mnq_5m", "entry_at_key_levels_mcl_5m", "new_high_acceptance_mes_5m", "new_high_acceptance_mnq_5m", "new_high_acceptance_mcl_5m", "manipulation_trade_mes_1m", "manipulation_trade_mnq_1m", "manipulation_trade_mcl_1m", "jump_in_downtrend_mes_1h", "jump_in_downtrend_mnq_1h", "jump_in_downtrend_mcl_1h", "bos_and_fvg_or_fvg_mes_15m", "bos_and_fvg_or_fvg_mnq_15m", "bos_and_fvg_or_fvg_mcl_15m", "vwap_cross_mes_15m", "vwap_cross_mnq_15m", "vwap_cross_mcl_15m", "entry_condition_mes_1h", "entry_condition_mnq_1h", "entry_condition_mcl_1h", "trade_era_scale_in_mes_4h", "trade_era_scale_in_mnq_4h", "trade_era_scale_in_mcl_4h"]
MEAN_REV_STRATS = ["ny_lunch_reversal", "midnight_open", "bounce_off_level", "mean_reversion_mes_5m", "mean_reversion_mnq_5m", "mean_reversion_mcl_5m"]
