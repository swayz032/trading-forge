...
# Stylized-fact calibration thresholds (conservative defaults)
_MIN_KURTOSIS = 0.3          # excess kurtosis > 0.3 (fat tails)
_MIN_ACF_SQUARED_LAG1 = 0.0  # acf of squared returns > 0 (vol clustering, direction only)
