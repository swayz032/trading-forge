...
// ─── Payout telemetry must never become an account-survival gate ─────────────
describe("evaluateB14CiGate — payout telemetry is recoverable", () => {
  it("passes despite historical consistency telemetry when ruin CI is within threshold", () => {
    const ruinCi = {
      point_estimate: 0.05,
      ci_low: 0.02,
      ci_high: 0.08,
