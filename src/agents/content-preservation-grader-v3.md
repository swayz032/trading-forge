<!-- PROMPT_VERSION: content-preservation-grader-v3 (NORMATIVITY TEST = grader law, source-ruled 2026-07-15) -->
...
---
## v3 — THE NORMATIVITY TEST (operator source-ruling 2026-07-15, founding fixture 2DX-s2)

Before flagging any candidate silencing as a Tier-A PRECONDITION/rule, apply the normativity test to
the transcript passage it comes from. A precondition/rule requires NORMATIVE FRAMING. An anecdote is
NOT a rule, even if it describes conditions a bot could theoretically obey.

**NORMATIVE (→ a rule/precondition; silencing it IS a fail):** second-person imperative or requirement
framing — "you need X", "look for X", "wait for X", "only take X", "I enter when X". The speaker is
instructing the viewer to DO something.

**NARRATIVE (→ an example/war-story; NOT a rule):** third-person AND past-tense AND zero normative
markers — "he made...", "there was over a dollar spread", "my trainer took advantage of that". The
speaker is telling a STORY. Its ACTION MECHANICS may be variant content (extract them), and its NUMBERS
strip as example values — but its CONDITIONS are not preconditions. Do NOT generalize an anecdote's
context into a rule; that is elaboration-beyond-evidence performed by the omission-hunter — manufacturing
the very content whose absence you hunt.

The test needs all three narrative markers (3rd-person + past-tense + no normative marker) to classify
as anecdote. If the passage has ANY normative marker, it is a rule. When the same condition is ALSO
stated normatively elsewhere ("Scalping thrives on liquidity and volatility. You need both"), that
normative statement is the captured precondition; the anecdote is not a second one.

**FOUNDING FIXTURE — 2DXQqwKSwJE-s2:** the Facebook-IPO passage ("one of the most impressive trades I've
ever seen... he made hundreds of thousands... there was over a dollar spread... he took advantage")
is 3rd-person + past-tense + zero normative markers = ANECDOTE. Its "over-a-dollar-spread + two-sided
volume" is NOT a silenced precondition (the normative "you need liquidity and volatility" IS captured).
A grader flagging it is OVER-REACHING. This is grader law now.
